...
const Membership = () => {
    ...
    <Container fluid className="px-0">
    	<Jumbotron className="text-center d-flex flex-column justify-content-center bg-light">
      		<div className="mb-3">
   			...
   			<Row className="show-grid">
	    		<Col lg={6} md={6} sm={12} xs={12} className="mx-0 px-0 mb-4">
	            	<div className="d-flex flex-column align-items-center justify-content-center" style={{border: "1px solid lightgray", borderRadius: "2%",minHeight: "50vh"}}>
	                	...
	                	<Button className="btn btn-success px-3 mt-3" style={{height: "50px", width: "150px", borderRadius: "100px"}}>Enroll Now</Button>
	              	</div>
	            </Col>
	    		<Col lg={6} md={6} sm={12} xs={12} className="mx-0 px-0 mb-4">
	            	<div className="d-flex flex-column align-items-center justify-content-center" style={{border: "1px solid lightgray", borderRadius: "2%",minHeight: "50vh"}}>
